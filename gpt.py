...
chatgpt_api_endpoint = "https://api.openai.com/v1/engines/chatgpt-model-name/completions"
...
def score_resume(resume_data, job_description):
    ...
    response = requests.post(chatgpt_api_endpoint, headers=headers, json={"prompt": prompt, "max_tokens": 150})
